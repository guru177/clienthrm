...
1. Admin opens Users → Create.
2. `POST /api/admin/users` with email, name, department, designation, roles.
3. Plan `max_users` enforced by `plan_limits`.
...
- [Departments](departments.md), [Designations](designations.md)

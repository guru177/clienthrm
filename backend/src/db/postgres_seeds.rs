...
fn seed_subscription_plans_if_empty(conn: &Connection) {
    ...
    let seeds: [(&str, &str, &str, &str, i64, &str, &str, i64); 4] = [
        ...
        (
            ...
            "month",
            200,
            r#"["dashboard","users","settings","centers","departments","designations","attendance","shifts","biometric","leave","holidays","payroll","payslips","projects","tasks","workflows","analytics"]"#,
        ...
        (
            ...
            "year",
            9999,
            r#"["dashboard","users","settings","centers","departments","designations","attendance","shifts","biometric","leave","holidays","payroll","payslips","projects","tasks","workflows","analytics","chat"]"#,

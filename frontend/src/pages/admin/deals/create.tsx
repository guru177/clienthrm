...
export default function CreateDeal() {
    ...
    const breadcrumbs = [
        ...
        { label: 'Create', href: '/admin/deals/create' },
    ];

    useEffect(() => {
        const fetchOptions = async () => {
            try {
                const [compRes, contRes, projRes, campRes, leadRes, userRes] = await Promise.allSettled([
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await axios.post('/admin/deals', submitData);

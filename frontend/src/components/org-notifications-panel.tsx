...
export function OrgNotificationsButton() {
    ...
    return (
        <div className="relative" ref={panelRef}>
            ...
            {open && (
                <div className="absolute right-0 top-full z-50 mt-2 w-[min(26rem,calc(100vw-2rem))] overflow-hidden rounded-xl border border-border bg-background shadow-2xl">
                    {/* Header */}
                    ...
                    {/* List */}
                    <div className="max-h-[min(28rem,65vh)] overflow-x-hidden overflow-y-auto">
                                                ...
                                                <div className="min-w-0 flex-1">
                                                    <div className="flex items-start justify-between gap-2">
                                                        <div className="min-w-0">
                                                            ...
                                                            <p className="mt-1.5 font-medium leading-snug text-foreground">{n.title}</p>
                                                        </div>
